...
// step length
#define SEQ_UTILS_STEP_LENS 11  // enumerated
#define SEQ_UTILS_STEP_32ND 0
#define SEQ_UTILS_STEP_DOT_32ND 1
#define SEQ_UTILS_STEP_16TH 2
#define SEQ_UTILS_STEP_DOT_16TH 3
#define SEQ_UTILS_STEP_8TH 4
#define SEQ_UTILS_STEP_DOT_8TH 5
#define SEQ_UTILS_STEP_QUARTER 6
#define SEQ_UTILS_STEP_DOT_QUARTER 7
#define SEQ_UTILS_STEP_HALF 8
#define SEQ_UTILS_STEP_DOT_HALF 9
#define SEQ_UTILS_STEP_WHOLE 10
