...
int gui_init(void) {
    ...
    //
    gui_set_label_prefs(GUI_LABEL_SONG, 3, 10, 60, 12,
       GUI_FONT_HEADING, GUI_FONT_COLOR_NORMAL, GUI_TEXT_BG_COLOR);

    gui_set_label_prefs(GUI_LABEL_TEMPO, 80, 10, 80, 12,
        GUI_FONT_HEADING, GUI_FONT_COLOR_NORMAL, GUI_TEXT_BG_COLOR);        

    gui_set_label_prefs(GUI_LABEL_SCENE, 176, 10, 60, 12,
        GUI_FONT_HEADING, GUI_FONT_COLOR_NORMAL, GUI_TEXT_BG_COLOR);

    gui_set_label_prefs(GUI_LABEL_RUN, 3, 28, 20, 12,
        GUI_FONT_NORMAL, GUI_FONT_COLOR_GREEN_DIM, GUI_TEXT_BG_COLOR);
    gui_set_label(GUI_LABEL_RUN, "RUN");
    
    gui_set_label_prefs(GUI_LABEL_REC, 36, 28, 20, 12,
        GUI_FONT_NORMAL, GUI_FONT_COLOR_RED_DIM, GUI_TEXT_BG_COLOR);
    gui_set_label(GUI_LABEL_REC, "REC");

    gui_set_label_prefs(GUI_LABEL_CLKSRC, 69, 28, 20, 12,
        GUI_FONT_NORMAL, GUI_FONT_COLOR_GREY, GUI_TEXT_BG_COLOR);
    gui_set_label(GUI_LABEL_CLKSRC, "INT");

    gui_set_label_prefs(GUI_LABEL_KEYTRANS, 130, 28, 60, 12,
        GUI_FONT_NORMAL, GUI_FONT_COLOR_MAGENTA_DIM, GUI_TEXT_BG_COLOR);
    gui_update_keyboard_transpose(0);
        
    gui_set_label_prefs(GUI_LABEL_LIVE, 200, 28, 30, 12,
        GUI_FONT_NORMAL, GUI_FONT_COLOR_CYAN_DIM, GUI_TEXT_BG_COLOR);
    gui_set_label(GUI_LABEL_LIVE, "LIVE");

    gui_set_label_prefs(GUI_LABEL_SONG_MODE, 3, 40, 20, 12,
        GUI_FONT_NORMAL, GUI_FONT_COLOR_YELLOW_DIM, GUI_TEXT_BG_COLOR);
    gui_set_label(GUI_LABEL_SONG_MODE, "SONG MODE");

    gui_set_label_prefs(GUI_LABEL_STATUS_L1, 8, 345, 224, 10,
        GUI_FONT_NORMAL, GUI_FONT_COLOR_NORMAL, GUI_TEXT_BG_COLOR);
        
    gui_set_label_prefs(GUI_LABEL_STATUS_L2, 8, 357, 224, 10,
        GUI_FONT_NORMAL, GUI_FONT_COLOR_NORMAL, GUI_TEXT_BG_COLOR);

    gui_set_label_prefs(GUI_LABEL_STATUS_L3, 8, 369, 224, 10,
        GUI_FONT_NORMAL, GUI_FONT_COLOR_NORMAL, GUI_TEXT_BG_COLOR);

    gui_set_label_prefs(GUI_LABEL_STATUS_L4, 8, 381, 224, 10,
        GUI_FONT_NORMAL, GUI_FONT_COLOR_NORMAL, GUI_TEXT_BG_COLOR);
